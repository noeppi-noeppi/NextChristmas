...
public class ModEntities {
    ...
    public static final EntityType<Sledge> sledge = EntityType.Builder.create(Sledge::new, EntityClassification.MISC).size(1.5f, 0.875f).trackingRange(10).build(NextChristmas.getInstance().modid + "_sledge");
